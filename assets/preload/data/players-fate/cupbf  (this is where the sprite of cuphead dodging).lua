...
function onCreate()
	...
	addAnimationByPrefix('bfthing', 'dodge', 'boyfriend dodge instance', 24, false);
	addAnimationByPrefix('cupthing', 'click', 'ShootLeft Instance', 24, false); -- Change to characters leftnote in XML
	-- Change to characters idle in XML
...
function onCreatePost()
	setObjectOrder('bfthing',getObjectOrder('racist')-1)
	setObjectOrder('dad',getObjectOrder('cupthing'))
end