...
class BaseOptionsMenu extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		descText.setFormat(Paths.font("sanspro-bold.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function changeSelection(change:Int = 0)
	{
		...
		if (girlfriend != null)
		{
			girlfriend.visible = optionsArray[curSelected].showGirlfriend;
		}
